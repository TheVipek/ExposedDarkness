...
public class MouseLook
{
    ...
    public MouseLook(Vector2 _sensitivity) => sensitivity = _sensitivity;
    ...
    {
        sensitivity.x = _sensitivity.x;
        sensitivity.y = _sensitivity.y;
    }
    ///<summary> Change mouse sensitivity to default value </summary>
    public void DefaultSensitivity() => sensitivity = defaultSensitivity;
}
...
public class PlayerCamera : MonoBehaviour
{
    ...
    [HideInInspector] public MouseLook mouse;
    ...
    {
        Vector2 move = ctx.ReadValue<Vector2>() * mouseSensitivity;
        mouse.setMove(move);
    }
