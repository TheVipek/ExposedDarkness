...
public class DisplayController : MonoBehaviour
{
    ...
    void FullScreenChecker(Toggle toggle)
    {
        ...
        if(toggle.isOn == true)
        {
            ...
            DisplaySettingsController.SetFullScreen(1);
            //Setting resolutionIdx to set it to default position (index 0 in dropdownOptions)
            DisplaySettingsController.SetResolution(intParameters,0);
    ...
    void ResolutionChangeHanlder(TMP_Dropdown dropdown)
    {
        ...
        //Save it to PlayerPrefs for next game launch
        DisplaySettingsController.SetFullScreen(3);
        DisplaySettingsController.SetResolution(intParameters,resolutionIdx);
